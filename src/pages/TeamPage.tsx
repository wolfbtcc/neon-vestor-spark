                      ...
                      return (
                        <div key={ref.id} className="flex items-center gap-2 p-2 rounded-lg bg-muted/50 border border-border">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[10px] text-muted-foreground">{ref.phone || '—'}</p>
                          </div>
                          <div className="text-right shrink-0">
                            <p className="text-[10px] text-muted-foreground">{d.toLocaleDateString('pt-BR')}</p>
                            <p className="text-[9px] text-muted-foreground">{d.toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}</p>
                          </div>
                        </div>
                      );
                    })}
