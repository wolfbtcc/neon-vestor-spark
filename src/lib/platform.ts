...
export const CYCLES = [
  { days: 1, returnPercent: 1.5, label: '1 dia' },
  { days: 15, returnPercent: 10, label: '15 dias' },
  { days: 30, returnPercent: 200, label: '30 dias' },
  { days: 60, returnPercent: 300, label: '60 dias' },
];
